...
Feature: Facility Management
  ...
  Scenario: Verify that client personnel can only view assigned facility
    ...
    And User tap on the "My Profile" link from side navigation
    Then User fetches the assigned facility list
    When User tap on the "Facilities" link from side navigation
